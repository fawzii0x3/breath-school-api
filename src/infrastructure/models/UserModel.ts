...
// Create and export the model (check if it already exists to avoid conflicts)
export const UserModel: Model<IUser> = mongoose.models.User || model<IUser>('User', UserSchema);
